...
if ! test -e underpants-micro || ! test -e catch-server || ! test -e are-you-being-served || ! test -e interface-inyourface || ! test -e hardware-setup || ! test -e first-slice-of-pi || ! test -e second-slice-of-pi || ! test -e pi-inyourface || ! test -e automatic-routing; then
  ...
  cp underpants-micro/README.md ../project-instructions/underpants-micro.md
  cp catch-server/README.md ../project-instructions/catch-server.md
